                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="time" value="08:00" class="form-control" name="site_name"
                                        id="field-1" placeholder="Company Name" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="time" value="17:00" class="form-control" min="09:00" max="18:00"
